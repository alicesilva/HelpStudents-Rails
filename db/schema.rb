...
ActiveRecord::Schema.define(version: 20180117164124) do
  ...
  create_table "absences", force: :cascade do |t|
    ...
    t.index ["course_id"], name: "index_absences_on_course_id", using: :btree
  end
  ...
  create_table "semesters", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_semesters_on_user_id", using: :btree
  end
